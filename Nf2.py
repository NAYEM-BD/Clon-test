...
try:
    rq = requests.get('https://github.com/NAYEM-BD/Clon-test/blob/main/Approve.text').text
...
_my_account_ = [
    'mdnayemhasan5258','100089948596624']
...
def banner():
        os.system("clear")
        os.system('echo -e " (*)\x1b[1;95m Auther    : NAYEM HASAN  \n \x1b[1;93m(*)\x1b[1;93m FB        : https://www.facebook.com/mdnayemhasan5258\n \x1b[1;93m(*)\x1b[1;95m Toolstatus: piad\n \x1b[1;93m(*)\x1b[1;91m Github    : htthttps://github.com/NAYEM-BD\n\x1b[1;97m------------------------------------------------" | lolcat')
        print("") 
...
def generate4(_cici_):
    ...
    return _azimvau_
def tambah_pass():
    print('%s '%(O));print('%s [%s•%s] %sEXAMPLE : %sAmerica,123456,102030,bangladesh,786786'%(H,P,H,K,H));cuy = _cici_azimvau_('%s [%s•%s] %sENTER MANUAL SUPPLEMENTAL PASS [1 WORD] : '%(H,P,H,K));gh = _azimvau_dapunta_('pass.txt','w');gh.write(cuy);gh.close
...
def tahun(fx):
    if (re.findall("[a-zA-Z]",str(fx))):tahunz=''
        ...
        if len(fx)==15:
            ...
            elif fx[:5] in ['10006','10007','10008','10009','10010']:tahunz = ' • 2021/2022/2023'
...
def genkey():
	try:
		...
		subprocess.check_output(["am", "start", "https://wa.me/+8801865272669"])
		exit()
	except(IOError):
		rb = rx
